...
<body>
            ...
            <div id="ins-text">
                ...
                <form
                    ...
                    <ul class="tb-no-decor">
                        ...
                        <li class="li-label-input"><label for="titulo">Título</label><input name="titulo"
                                placeholder="Título" type="text">
                        </li>
                        <li class="li-label-input"><label for="autor">Autor</label><input name="autor"
                                placeholder="Autor" type="text"></li>
                        <li class="li-label-input"><label for="contenido">Contenido</label><textarea
                                placeholder="Cuerpo" name="contenido" rows="7"></textarea>
                        </li>
                        <li class="li-label-input"><label for="lang">Idioma</label><input name="lang"
                                placeholder="Idioma" type="text"></li>
    ...
    echo '<option  value='.$category->getId().'  >'.$category->getName().'</option>';
                            ...
                            <p id="form-info"></p>
                        <li><button class="button" type="button" onclick='validar()'>INSERTAR</button></li>
